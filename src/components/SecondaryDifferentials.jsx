                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <ul className="space-y-6">
                        {benefits.map((benefit, index) => (
                            <li
                                key={index}
                                className="flex items-center gap-4 bg-white/5 backdrop-blur-sm p-5 rounded-xl border border-white/10 transition-all hover:translate-x-2 hover:bg-white/10 hover:border-brand-green/30"
                            >
